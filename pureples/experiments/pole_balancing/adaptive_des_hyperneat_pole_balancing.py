...
if __name__ == '__main__':
    ...
    NET = NETWORK.create_phenotype_network(CONFIG, 
        filename=f"pureples/experiments/pole_balancing/results/adaptive_des_hyperneat_pole_balancing_{VERSION_TEXT}_winner")
    draw_net(
        CPPN, filename=f"pureples/experiments/pole_balancing/results/adaptive_des_hyperneat_pole_balancing_{VERSION_TEXT}_cppn")
    with open(f'pureples/experiments/pole_balancing/results/adaptive_des_hyperneat_pole_balancing_{VERSION_TEXT}_cppn.pkl', 'wb') as output:
